...
def main(args=None):
    ...
    api_path='/home/dara/catkin_ws/src/multi_camera_husky/KerasObjectDetector/examples/'

    # Load Sample Images
    img_path = api_path + '000000008021.jpg'
    image = yolk.detector.preprocessing_image(img_path, args)

    # Generate Model including loss & sgd
    model_path = api_path + 'VGG_VOC0712Plus_SSD_300x300_ft_iter_160000.h5'
